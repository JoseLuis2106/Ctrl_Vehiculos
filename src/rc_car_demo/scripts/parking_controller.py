...
LOOKAHEAD_DIST      = 0.6                               # Necesitara cambios
CUSP_TOLERANCE      = 0.10                              # Necesitara cambios
GOAL_TOLERANCE      = 0.10                              # Necesitara cambios
GOAL_YAW_TOL        = 0.03   # ~1.7°
MAX_SPEED           = 0.70                              # Necesitara cambios
MIN_SPEED           = 0.15                              # Necesitara cambios
MICRO_SPEED         = 0.08                              # Necesitara cambios
K_ANGULAR           = 6.5                               # Necesitara cambios
K_YAW_ALIGN         = 7.5                               # Necesitara cambios
MAX_STEER           = 1.20                              # Necesitara cambios
...
class ParkingController(Node):
    ...
    def scan_callback(self, msg):
        ...
        for p in pc2.read_points(msg, field_names=("x", "y", "z"), skip_nans=True):
            ...
            if -0.1 < p[2] < 0.1 and 0.1 < dist < 10.0:
